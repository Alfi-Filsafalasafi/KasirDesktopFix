...
Public Class LaporanPenjualan
    ...
    Private Sub getData()
        ...
        sql = "select id_transaksi,tanggal,waktu,total,bayar,kembalian from t_jual"
    ...
    Private Sub filterData()
        ...
        sql = "select id_transaksi,tanggal,waktu,total,bayar,kembalian from t_jual where t_jual.tanggal >= '" & date_dari.Text & "' and t_jual.tanggal <= '" & date_sampai.Text & "'"
        da = New SqlDataAdapter(sql, koneksi)
        ds = New DataSet
        da.Fill(ds, 0)
        dgv.DataSource = ds.Tables(0)
